// Radial.h: interface for the Radial class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
//////////////////////////////////////////////////////////////////////

#if !defined(POTENTIAL_RADIAL__INCLUDED_)
#define POTENTIAL_RADIAL__INCLUDED_
...
public: 
	...
	typedef Potential::Radial::Energy<1> tangent_type;
...
public: 
	...
	typedef Potential::Radial::Energy<2> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
#endif // !defined(POTENTIAL_RADIAL__INCLUDED_)
