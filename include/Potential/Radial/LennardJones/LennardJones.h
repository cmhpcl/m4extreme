// LennardJones.h: interface for the LennardJones class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
//////////////////////////////////////////////////////////////////////

#if !defined(POTENTIAL_LENNARDJONES__INCLUDED_)
#define POTENTIAL_LENNARDJONES__INCLUDED_
...
public:
	...
	Data(const double &, const double &,
	     ...
	     bool rhs_IsCompressiveOnly = false);
	Data(const Data &);
	Data & operator = (const Data &);
	void Randomize();

private:
	bool IsCompressiveOnly;
	double EMin;
	double RMin;
	double m;
	double n;
...
public: 
	...
	typedef Potential::Radial::LennardJones::Energy<0> energy_type;
...
public: 
	...
	typedef Potential::Radial::LennardJones::Energy<1> tangent_type;
...
public: 
	...
	typedef Potential::Radial::LennardJones::Energy<2> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Potential::Radial::LennardJones::Energy<3> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
#endif // !defined(POTENTIAL_LENNARDJONES__INCLUDED_)
