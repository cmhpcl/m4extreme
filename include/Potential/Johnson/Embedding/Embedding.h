...
#if !defined(POTENTIAL_JOHNSON_EMBEDDING__INCLUDED_)
#define POTENTIAL_JOHNSON_EMBEDDING__INCLUDED_
...
public:
	...
	typedef Potential::Johnson::Embedding::LocalState local_state_type;
	typedef Potential::Johnson::Embedding::Energy<0> energy_type;
	typedef Potential::Johnson::Embedding::Jet<0> jet_type;
...
public: 
	...
	typedef Potential::Johnson::Embedding::Energy<1> tangent_type;
...
public: 
	...
	typedef Potential::Johnson::Embedding::Energy<2> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Potential::Johnson::Embedding::Energy<3> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Potential::Johnson::Embedding::Jet<1> tangent_type;
	typedef double domain_type;
...
public: 
	...
	typedef Potential::Johnson::Embedding::Jet<2> tangent_type;
	typedef double domain_type;
	typedef pair<double,double> range_type;
...
#endif // !defined(POTENTIAL_JOHNSON_EMBEDDING__INCLUDED_)
