// Embedding.h: interface for the Embedding class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
//////////////////////////////////////////////////////////////////////

#if !defined(POTENTIAL_FINNISSINCLAIR_EMBEDDING__INCLUDED_)
#define POTENTIAL_FINNISSINCLAIR_EMBEDDING__INCLUDED_
...
public:
	...
	typedef Potential::FinnisSinclair::Embedding::LocalState local_state_type;
	typedef Potential::FinnisSinclair::Embedding::Energy<0> energy_type;
	typedef Potential::FinnisSinclair::Embedding::Jet<0> jet_type;
...
public: 
	...
	typedef Potential::FinnisSinclair::Embedding::Energy<1> tangent_type;
...
public: 
	...
	typedef Potential::FinnisSinclair::Embedding::Energy<2> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Potential::FinnisSinclair::Embedding::Energy<3> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Potential::FinnisSinclair::Embedding::Jet<1> tangent_type;
	typedef double domain_type;
...
public: 
	...
	typedef Potential::FinnisSinclair::Embedding::Jet<2> tangent_type;
	typedef double domain_type;
	typedef pair<double,double> range_type;
...
#endif // !defined(POTENTIAL_FINNISSINCLAIR_EMBEDDING__INCLUDED_)
