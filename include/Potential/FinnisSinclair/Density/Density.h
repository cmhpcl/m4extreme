// Density.h: interface for the Density class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
//////////////////////////////////////////////////////////////////////

#if !defined(POTENTIAL_FINNISSINCLAIR_DENSITY__INCLUDED_)
#define POTENTIAL_FINNISSINCLAIR_DENSITY__INCLUDED_
...
public:
	...
	typedef Potential::FinnisSinclair::Density::LocalState local_state_type;
	typedef Potential::FinnisSinclair::Density::Energy<0> energy_type;
	typedef Potential::FinnisSinclair::Density::Jet<0> jet_type;
...
public: 
	...
	typedef Potential::FinnisSinclair::Density::Energy<1> tangent_type;
...
public: 
	...
	typedef Potential::FinnisSinclair::Density::Energy<2> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Potential::FinnisSinclair::Density::Energy<3> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Potential::FinnisSinclair::Density::Jet<1> tangent_type;
	typedef double domain_type;
...
public: 
	...
	typedef Potential::FinnisSinclair::Density::Jet<2> tangent_type;
	typedef double domain_type;
	typedef pair<double,double> range_type;
...
#endif // !defined(POTENTIAL_FINNISSINCLAIR_DENSITY__INCLUDED_)
