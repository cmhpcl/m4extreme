...
#if !defined(POTENTIAL_FINNISSINCLAIR_PAIRPOTENTIAL__INCLUDED_)
#define POTENTIAL_FINNISSINCLAIR_PAIRPOTENTIAL__INCLUDED_
...
public:
	...
	typedef Potential::FinnisSinclair::PairPotential::LocalState local_state_type;
	typedef Potential::FinnisSinclair::PairPotential::Energy<0> energy_type;
	typedef Potential::FinnisSinclair::PairPotential::Jet<0> jet_type;
...
public: 
	...
	typedef Potential::FinnisSinclair::PairPotential::Energy<1> tangent_type;
...
public: 
	...
	typedef Potential::FinnisSinclair::PairPotential::Energy<2> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Potential::FinnisSinclair::PairPotential::Energy<3> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Potential::FinnisSinclair::PairPotential::Jet<1> tangent_type;
	typedef double domain_type;
...
public: 
	...
	typedef Potential::FinnisSinclair::PairPotential::Jet<2> tangent_type;
	typedef double domain_type;
	typedef pair<double,double> range_type;
...
#endif // !defined(POTENTIAL_FINNISSINCLAIR_PAIRPOTENTIAL__INCLUDED_)
