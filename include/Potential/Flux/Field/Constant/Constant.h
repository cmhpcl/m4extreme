...
#if !defined(FLUX_FIELD_CONSTANT__INCLUDED_)
#define FLUX_FIELD_CONSTANT__INCLUDED_
...
namespace Flux
{
  namespace Field
  {
	...
	public: 
	  ...
	  typedef Flux::Field::Constant::Energy<2> tangent_type;
	...
	public: 
	  ...
	  typedef Flux::Field::Constant::Energy<3> tangent_type;
	  typedef Set::VectorSpace::Vector vector_type;
	  typedef double domain_type;
	  typedef double range_type;
