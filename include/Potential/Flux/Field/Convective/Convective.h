...
#if !defined(FLUX_FIELD_CONVECTIVE__INCLUDED_)
#define FLUX_FIELD_CONVECTIVE__INCLUDED_
...
namespace Flux
{
  namespace Field
  {
	...
	public: 
	  ...
	  typedef Flux::Field::Convective::Energy<2> tangent_type;
	  typedef double domain_type;
	...
	public: 
	  ...
	  typedef Flux::Field::Convective::Energy<3> tangent_type;
	  typedef double domain_type;
	  typedef double range_type;
...
#endif // !defined(FLUX_FIELD_CONVECTIVE__INCLUDED_)
