// NeoHookean.h: interface for the NeoHookean class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
//////////////////////////////////////////////////////////////////////

#if !defined(MATERIAL_LAW_NEOHOOKEAN_H__INCLUDED_)
#define MATERIAL_LAW_NEOHOOKEAN_H__INCLUDED_
...
public: 
	...
	typedef Material::NeoHookean::Energy<0> energy_type;
...
public: 
	...
	typedef Material::NeoHookean::Energy<1> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::NeoHookean::Energy<2> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::NeoHookean::Energy<3> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::NeoHookean::Jet<1> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::NeoHookean::Jet<2> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
