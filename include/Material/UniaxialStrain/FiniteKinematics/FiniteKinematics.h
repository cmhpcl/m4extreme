...
#if !defined(SET_MATERIAL_UNIAXIALSTRAIN_FINITEKINEMATICS_H__INCLUDED_)
#define SET_MATERIAL_UNIAXIALSTRAIN_FINITEKINEMATICS_H__INCLUDED_
...
public: 
	...
	typedef FiniteKinematics::Energy<0> energy_type;
...
public: 
	...
	typedef FiniteKinematics::Energy<1> tangent_type;
...
public: 
	...
	typedef FiniteKinematics::Energy<2> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef FiniteKinematics::Energy<3> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef FiniteKinematics::Jet<1> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef FiniteKinematics::Jet<2> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
#endif // !defined(SET_MATERIAL_UNIAXIALSTRAIN_FINITEKINEMATICS_H__INCLUDED_)
