...
#if !defined(MATERIAL_SYMMETRIC_FINITEKINEMATICS_H__INCLUDED_)
#define MATERIAL_SYMMETRIC_FINITEKINEMATICS_H__INCLUDED_
...
public: 
	...
	void operator ++ ();
        ...
        Material::Symmetric::LocalState * GetMSLS() const {return LSSym;}
        void Reset(double T_) { return LSSym->Reset(T_); }
	void Relax() { return LSSym->Relax(); }
        double GetTemperature() const { return LSSym->GetTemperature(); }
        virtual void write(ostream & os) const { return LSSym->write(os); }
	virtual void read(istream & is) { return LSSym->read(is); }
private:
...
public: 
	...
	typedef Material::Symmetric::FiniteKinematics::Energy<1> tangent_type;
...
public: 
	...
	typedef Material::Symmetric::FiniteKinematics::Energy<2> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
private:
	...
	//
	Material::Symmetric::LK2FK::Energy<1> *_LK2FKDW;
...
public: 
	...
	typedef Material::Symmetric::FiniteKinematics::Energy<3> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::Symmetric::FiniteKinematics::Jet<1> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::Symmetric::FiniteKinematics::Jet<2> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
#endif // !defined(MATERIAL_SYMMETRIC_FINITEKINEMATICS_H__INCLUDED_
