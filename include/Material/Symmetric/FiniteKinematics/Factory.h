...
#if !defined(MATERIAL_SYMMETRIC_FINITEKINEMATICS_FACTORY_H__INCLUDED_)
#define MATERIAL_SYMMETRIC_FINITEKINEMATICS_FACTORY_H__INCLUDED_
...
public: 
	...
	typedef Material::Symmetric::FiniteKinematics::LocalState fk_ls_type;
	typedef Material::Symmetric::FiniteKinematics::Energy<0> fk_e_type;
	typedef Material::Symmetric::FiniteKinematics::Energy<1> fk_de_type;
	typedef Material::Symmetric::FiniteKinematics::Energy<2> fk_dde_type;
	typedef Material::Symmetric::FiniteKinematics::Jet<0> fk_j_type;
	typedef Material::Symmetric::FiniteKinematics::Jet<1> fk_dj_type;
	...
	{
		if (LS  == 0) NewLS();
		if (DDW == 0) DDW = new fk_dde_type(Fact0->GetDDW(), Fact0->GetDJ());
		return DDW;
	}
...
public: 
	...
	{
	    return new Material::Symmetric::FiniteKinematics::Factory(Bld0->Build());
	}
...
#endif // !defined(MATERIAL_SYMMETRIC_FINITEKINEMATICS_FACTORY_H__INCLUDED_
