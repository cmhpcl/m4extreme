// PronyUnbounded.h: interface for the PronyUnbounded class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
//////////////////////////////////////////////////////////////////////

#if !defined(MATERIAL_SYMMETRIC_PRONYUNBOUNDED_H__INCLUDED_)
#define MATERIAL_SYMMETRIC_PRONYUNBOUNDED_H__INCLUDED_
...
public:
	...
	vector<double> & GetMu();
	const vector<double> & GetTau() const;
...
public: 
	...
	typedef Material::Symmetric::PronyUnbounded::Energy<0> energy_type;
	typedef Set::VectorSpace::Sym domain_type;

	LocalState();
	virtual ~LocalState();
	LocalState(Data *, Clock *);
	LocalState(Data *, Clock *, const vector<Set::VectorSpace::Sym> &);
	Material::Symmetric::LocalState *Clone() const;
	LocalState(const LocalState &);
	void operator () (const domain_type &);
	void operator ++ ();
	const vector<Set::VectorSpace::Sym> & GetEpsp() const;
	vector<Set::VectorSpace::Sym> & GetEpsp();
	const vector<Set::VectorSpace::Sym> & GetEpspOld() const;
	vector<Set::VectorSpace::Sym> & GetEpspOld();

private:

	Data *Properties; Clock *Chronos; 
	vector<Set::VectorSpace::Sym> Epsp;
...
public: 
	...
	typedef Material::Symmetric::PronyUnbounded::Energy<1> tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
...
public: 
	...
	typedef Material::Symmetric::PronyUnbounded::Energy<2> tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
...
public: 
	...
	typedef Material::Symmetric::PronyUnbounded::Energy<3> tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
...
public: 
	...
	typedef Material::Symmetric::PronyUnbounded::Jet<1> tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
...
public: 
	...
	typedef Material::Symmetric::PronyUnbounded::Jet<2> tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
...
#endif // !defined(MATERIAL_SYMMETRIC_PRONYUNBOUNDED_H__INCLUDED_
