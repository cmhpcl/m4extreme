...
#if !defined(MATERIAL_SYMMETRIC_J2ISOTROPICADIABATIC_H__INCLUDED_)
#define MATERIAL_SYMMETRIC_J2ISOTROPICADIABATIC_H__INCLUDED_
    ...
    namespace Symmetric {
        namespace J2IsotropicAdiabatic {
            ...
            public:
                ...
                typedef Material::Symmetric::J2IsotropicAdiabatic::Energy < 0 > energy_type;
		...
		LocalState(const LocalState &);
                ...
                LocalState(Clock *, double, double,
		...
		virtual void read(istream & is);
            ...
            private:
                ...
                Material::Gas::EoS::LocalState * _pEoSLS_T;
                Material::Gas::EoS::LocalState * _pEoSLS_J;
                Material::Gas::EoS::Energy < 1 > *Df;
                Material::Gas::EoS::Energy < 2 > *DDf;
		Material::Shear::Modulus<0> * G;		

                Material::Uniaxial::Energy < 0 > * MT; //melting temperature
		...
		Material::Symmetric::Energy<0> * Phi;
            ...
            private:
                ...
                double _GetDW(const double, const double, const domain_type &);
            ...
            public:
                ...
                typedef Material::Symmetric::J2IsotropicAdiabatic::Energy < 1 > tangent_type;
                typedef Set::VectorSpace::Sym domain_type;
		...
		virtual range_type operator () (const domain_type &, double) const;
            ...
            public:
                ...
                typedef Material::Symmetric::J2IsotropicAdiabatic::Energy < 2 > tangent_type;
                typedef Set::VectorSpace::Sym domain_type;
		...
		Material::Symmetric::Energy<1> *DPhi;
            ...
            public:
                ...
                typedef Material::Symmetric::J2IsotropicAdiabatic::Energy < 3 > tangent_type;
                typedef Set::VectorSpace::Sym domain_type;
		...
		virtual double operator () (const domain_type &, double) const;
            ...
            public:
                ...
                typedef Material::Symmetric::J2IsotropicAdiabatic::Jet < 1 > tangent_type;
                typedef Set::VectorSpace::Sym domain_type;
            ...
            public:
                ...
                typedef Material::Symmetric::J2IsotropicAdiabatic::Jet < 2 > tangent_type;
                typedef Set::VectorSpace::Sym domain_type;
...
#endif // !defined(MATERIAL_SYMMETRIC_J2ISOTROPICADIABATIC_H__INCLUDED_
