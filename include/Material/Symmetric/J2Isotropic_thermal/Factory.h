// Factory.h: Factory for the J2Isotropic_thermal class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
//////////////////////////////////////////////////////////////////////

#if !defined(MATERIAL_SYMMETRIC_J2ISOTROPIC__THERMAL_FACTORY_H__INCLUDED_)
#define MATERIAL_SYMMETRIC_J2ISOTROPIC_THERMAL_FACTORY_H__INCLUDED_

#pragma once

#include <vector>
#include "J2Isotropic_thermal.h"
...
public: 
	...
	typedef Material::Symmetric::J2Isotropic_thermal::LocalState lk_fact_type;
	typedef Material::Symmetric::J2Isotropic_thermal::Energy<0> lk_e_type;
	typedef Material::Symmetric::J2Isotropic_thermal::Energy<1> lk_de_type;
	typedef Material::Symmetric::J2Isotropic_thermal::Energy<2> lk_dde_type;
	typedef Material::Symmetric::J2Isotropic_thermal::Jet<0> lk_j_type;
	typedef Material::Symmetric::J2Isotropic_thermal::Jet<1> lk_dj_type;
	...
	Factory(Material::Symmetric::J2Isotropic_thermal::Data *D_,
	...
	{
		if (LKLS == 0) LKLS = 
		new lk_fact_type(C,D,EoSFact->GetLS(), SheFact->GetLS(), 
				 SheFact->GetG(),HarFact->GetDW(),
...
private:
	...
	Material::Symmetric::J2Isotropic_thermal::Data *D;
	Material::Symmetric::J2Isotropic_thermal::LocalState *LKLS;
	Material::Symmetric::J2Isotropic_thermal::Energy<0> *LKW;
	Material::Symmetric::J2Isotropic_thermal::Energy<1> *LKDW;
	Material::Symmetric::J2Isotropic_thermal::Energy<2> *LKDDW;
	Material::Symmetric::J2Isotropic_thermal::Jet<0> *LKJ;
	Material::Symmetric::J2Isotropic_thermal::Jet<1> *LKDJ;
...
public: 
	...
	Builder(Material::Symmetric::J2Isotropic_thermal::Data *D_,
	...
	{
	  return new Material::Symmetric::J2Isotropic_thermal::Factory(D,SheB,HarB,RatB,EoSB,C);
	}
