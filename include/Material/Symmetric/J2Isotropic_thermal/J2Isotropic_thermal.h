// J2Isotropic_thermal.h: interface for the J2Isotropic_thermal class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
//////////////////////////////////////////////////////////////////////

#if !defined(MATERIAL_SYMMETRIC_J2ISOTROPIC_THERMAL_H__INCLUDED_)
#define MATERIAL_SYMMETRIC_J2ISOTROPIC_THERMAL_H__INCLUDED_
...
public:
    Data(m4extreme::Utils::ApparentHeatCapacity *HeatCapacity_,
	 m4extreme::Utils::ScalarField *Melting_Temperature_,
	 m4extreme::Utils::ScalarField *Boiling_Temperature_,
	 double rho_,    double beta_, 
	 double T0_,     double Tm_,  double Tb_,
	 double alpha_,  double a_, 
	 double E0_,     double Epsc_);
...
private:
    m4extreme::Utils::ApparentHeatCapacity *HeatCapacity;
    m4extreme::Utils::ScalarField *Melting_Temperature;
    m4extreme::Utils::ScalarField *Boiling_Temperature;

    double rho, beta, T0, Tm, Tb, alpha, a, E0, Epsc;
};
...
public: 
	...
	typedef Material::Symmetric::J2Isotropic_thermal::Energy<0> energy_type;
	...
	Set::VectorSpace::Sym & GetEpspOld();
        Material::Gas::EoS::LocalState * GetMLS() const;
...
protected:
	...
	Material::Shear::LocalState *MuLS;
...
public: 
	...
	typedef Material::Symmetric::J2Isotropic_thermal::Energy<1> tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
...
public: 
	...
	typedef Material::Symmetric::J2Isotropic_thermal::Energy<2> tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
...
public: 
	...
	typedef Material::Symmetric::J2Isotropic_thermal::Energy<3> tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
...
public: 
	...
	typedef Material::Symmetric::J2Isotropic_thermal::Jet<1> tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
...
public: 
	...
	typedef Material::Symmetric::J2Isotropic_thermal::Jet<2> tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
