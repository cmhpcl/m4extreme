...
#if !defined(MATERIAL_SYMMETRIC_HOOKEAN_CUBIC_FACTSYM_H__INCLUDED_)
#define MATERIAL_SYMMETRIC_HOOKEAN_CUBIC_FACTSYM_H__INCLUDED_
...
public: 
	...
	FactSym(Material::Symmetric::Hookean::Cubic::Data *Dat_) : Dat(Dat_),
...
public: 
	...
	BuildSym(Material::Symmetric::Hookean::Cubic::Data *D_) : D(D_) {}

	Material::Symmetric::Factory * Build() const
	{
		return new Material::Symmetric::Hookean::Cubic::FactSym(D);
	}
...
#endif // !defined(MATERIAL_SYMMETRIC_HOOKEAN_CUBIC_FACTSYM_H__INCLUDED_
