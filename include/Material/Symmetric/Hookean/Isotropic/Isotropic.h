...
#if !defined(MATERIAL_SYMMETRIC_HOOKEAN_ISOTROPIC_H__INCLUDED_)
#define MATERIAL_SYMMETRIC_HOOKEAN_ISOTROPIC_H__INCLUDED_
...
namespace Material
{
  namespace Symmetric
  {
	...
	private:
	  ...
	  double Lambda, L1, L2; //coefficients of the second order polynomial function of temperature
	  double Mu, M1, M2; // coefficient of the second order polynomial function of temperature
	};
	...
	class LocalState : public Material::Symmetric::LocalState
	  ...
	  public: 
	    ...
	    typedef Material::Symmetric::Hookean::Isotropic::Data data_type;
	    typedef Material::Symmetric::Hookean::Isotropic::Energy<0> energy_type;
	    ...
	    const double & GetLambda() const;
	    const double & GetMu() const;
	    double GetThermalExpansion() const;
	...
	template<>
	  ...
	  public: 
	    ...
	    typedef Material::Symmetric::Hookean::Isotropic::Energy<1> tangent_type;
	    typedef Set::VectorSpace::Sym domain_type;
	...
	template <>
	  ...
	  public: 
	    ...
	    typedef Material::Symmetric::Hookean::Isotropic::Energy<2> tangent_type;
	    typedef Set::VectorSpace::Sym domain_type;
	...
	template <>
	  ...
	  public: 
	    ...
	    typedef Material::Symmetric::Hookean::Isotropic::Energy<3> tangent_type;
	    typedef Set::VectorSpace::Sym domain_type;
	...
	template<>
	  ...
	  public: 
	    ...
	    typedef Material::Symmetric::Hookean::Isotropic::Jet<1> tangent_type;
	    typedef Set::VectorSpace::Sym domain_type;
	...
	template <>
	  ...
	  public: 
	    ...
	    typedef Material::Symmetric::Hookean::Isotropic::Jet<2> tangent_type;
	    typedef Set::VectorSpace::Sym domain_type;
...
#endif // !defined(MATERIAL_SYMMETRIC_HOOKEAN_ISOTROPIC_H__INCLUDED_
