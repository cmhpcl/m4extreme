...
#if !defined(MATERIAL_SYMMETRIC_HOOKEAN_HEXAGONAL_H__INCLUDED_)
#define MATERIAL_SYMMETRIC_HOOKEAN_HEXAGONAL_H__INCLUDED_
...
public: 
	...
	typedef Material::Symmetric::Hookean::Hexagonal::Data data_type;
	typedef Material::Symmetric::Hookean::Hexagonal::Energy<0> energy_type;
...
public: 
	...
	typedef Material::Symmetric::Hookean::Hexagonal::Energy<1> tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
...
public: 
	...
	typedef Material::Symmetric::Hookean::Hexagonal::Energy<2> tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
...
public: 
	...
	typedef Material::Symmetric::Hookean::Hexagonal::Energy<3> tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
...
public: 
	...
	typedef Material::Symmetric::Hookean::Hexagonal::Jet<1> tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
...
public: 
	...
	typedef Material::Symmetric::Hookean::Hexagonal::Jet<2> tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
...
#endif // !defined(MATERIAL_SYMMETRIC_HOOKEAN_HEXAGONAL_H__INCLUDED_
