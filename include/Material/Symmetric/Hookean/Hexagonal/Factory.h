...
#if !defined(MATERIAL_SYMMETRIC_HOOKEAN_HEXAGONAL_FACTORY_H__INCLUDED_)
#define MATERIAL_SYMMETRIC_HOOKEAN_HEXAGONAL_FACTORY_H__INCLUDED_
...
public: 
	...
	Factory(Material::Symmetric::Hookean::Hexagonal::Data *Dat_) : Dat(Dat_),
...
public: 
	...
	Builder(Material::Symmetric::Hookean::Hexagonal::Data *D_) : D(D_) {}

	Material::Symmetric::Factory * Build() const
	{
		return new Material::Symmetric::Hookean::Hexagonal::Factory(D);
	}
...
#endif // !defined(MATERIAL_SYMMETRIC_HOOKEAN_HEXAGONAL_FACTORY_H__INCLUDED_
