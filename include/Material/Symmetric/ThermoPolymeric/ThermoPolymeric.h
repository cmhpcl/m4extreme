// ThermoPolymeric.h: interface for the ThermoPolymeric class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
////////////////////////////////////////////////////////////////////////////

#if !defined(MATERIAL_THERMOPOLYMERIC_H__INCLUDED_)
#define MATERIAL_THERMOPOLYMERIC_H__INCLUDED_
...
namespace Material {
  namespace Symmetric {
	...
	double T0, Tm;
	double k0, kt, alpha, beta;
	double nu0, num, nuc, nu_exp;
	double eta0;
	double Tc;
	double a1, b1, a2, b2, m, n, R, B0, Bc, Mu0, Muc;
      };
	...
	typedef Material::Symmetric::ThermoPolymeric::Energy < 0 > energy_type;
	...
	typedef Material::Symmetric::ThermoPolymeric::Energy < 1 > tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
	...
	typedef Material::Symmetric::ThermoPolymeric::Energy < 2 > tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
	...
	typedef Material::Symmetric::ThermoPolymeric::Energy < 3 > tangent_type;
	typedef Set::VectorSpace::Sym domain_type;
	...
	public: 
	  ...
	  typedef Material::Symmetric::ThermoPolymeric::Jet<1> tangent_type;
	  typedef Set::VectorSpace::Sym domain_type;
	...
	public: 
	  ...
	  typedef Material::Symmetric::ThermoPolymeric::Jet<2> tangent_type;
	  typedef Set::VectorSpace::Sym domain_type;
...
#endif // !defined(MATERIAL_THERMOPOLYMERIC_H__INCLUDED_
