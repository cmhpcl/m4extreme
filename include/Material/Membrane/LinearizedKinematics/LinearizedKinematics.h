...
#if !defined(MATERIAL_MEMBRANE_LINEARIZEDKINEMATICS_H__INCLUDED_)
#define MATERIAL_MEMBRANE_LINEARIZEDKINEMATICS_H__INCLUDED_
...
#endif // !defined(MATERIAL_MEMBRANE_LINEARIZEDKINEMATICS_H__INCLUDED_)
