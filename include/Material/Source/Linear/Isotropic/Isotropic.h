...
#if !defined(MATERIAL_SOURCE_LINEAR_ISOTROPIC_H__INCLUDED_)
#define MATERIAL_SOURCE_LINEAR_ISOTROPIC_H__INCLUDED_
...
public: 
	...
	typedef Material::Source::Linear::Isotropic::Energy<0> energy_type;
...
public: 
	...
	typedef Material::Source::Linear::Isotropic::Energy<1> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::Source::Linear::Isotropic::Energy<2> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::Source::Linear::Isotropic::Energy<3> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::Source::Linear::Isotropic::Jet<1> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::Source::Linear::Isotropic::Jet<2> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
#endif // !defined(MATERIAL_SOURCE_LINEAR_ISOTROPIC_H__INCLUDED_
