...
#if !defined(SET_MATERIAL_PLANESTRAIN_FINITEKINEMATICS_H__INCLUDED_)
#define SET_MATERIAL_PLANESTRAIN_FINITEKINEMATICS_H__INCLUDED_
...
#endif // !defined(SET_MATERIAL_PLANESTRAIN_FINITEKINEMATICS_H__INCLUDED_)
