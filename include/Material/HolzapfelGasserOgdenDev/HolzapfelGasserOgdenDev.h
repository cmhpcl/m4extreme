// HolzapfelGasserOgdenDev.h: interface for the HolzapfelGasserOgdenDev class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
/////////////////////////////////////////////////////////////////////////////////

#if !defined(MATERIAL_LAW_HOLZAPFELGASSEROGDENDEV_H__INCLUDED_)
#define MATERIAL_LAW_HOLZAPFELGASSEROGDENDEV_H__INCLUDED_
...
public: 
	...
	typedef Material::HolzapfelGasserOgdenDev::Energy<0> energy_type;
	typedef Set::VectorSpace::Vector domain_type;

	LocalState(Data *);
	LocalState(Data *, const Set::VectorSpace::Vector &);
	virtual ~LocalState();
	Material::LocalState *Clone() const;
	LocalState(const LocalState &);
	void operator ++ ();

	const Set::VectorSpace::Vector & GetOrientation() const;
	void SetOrientation(const Set::VectorSpace::Vector &);

	const Set::VectorSpace::Vector & GetNOld() const;
	void UpdateOrientation(const Set::VectorSpace::Hom &);
private:
	Set::VectorSpace::Vector N, NOld;
	Data *Properties;
...
public: 
	...
	typedef Material::HolzapfelGasserOgdenDev::Energy<1> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::HolzapfelGasserOgdenDev::Energy<2> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::HolzapfelGasserOgdenDev::Energy<3> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::HolzapfelGasserOgdenDev::Jet<1> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::HolzapfelGasserOgdenDev::Jet<2> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
