// Thermal.h: interface for the Thermal class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
//////////////////////////////////////////////////////////////////////

#if !defined(MATERIAL_HOOKEAN_ISOTROPIC_THERMAL_H__INCLUDED_)
#define MATERIAL_HOOKEAN_ISOTROPIC_THERMAL_H__INCLUDED_
...
public:
	...
	Data(const double &, const double &, const double &, const double &);
	Data(const Data &);
...
public: 
	...
	typedef Material::Hookean::Isotropic::Thermal::Energy<0> energy_type;
...
public: 
	...
	typedef Material::Hookean::Isotropic::Thermal::Energy<1> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::Hookean::Isotropic::Thermal::Energy<2> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::Hookean::Isotropic::Thermal::Energy<3> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::Hookean::Isotropic::Thermal::Jet<1> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
public: 
	...
	typedef Material::Hookean::Isotropic::Thermal::Jet<2> tangent_type;
	typedef Set::VectorSpace::Vector domain_type;
...
#endif // !defined(MATERIAL_HOOKEAN_ISOTROPIC_THERMAL_H__INCLUDED_
