// ShearViscosity.h: interface for the ShearViscosity class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
//////////////////////////////////////////////////////////////////////

#if !defined(MATERIAL_UNIAXIAL_SHEARVISCOSITY__INCLUDED_)
#define MATERIAL_UNIAXIAL_SHEARVISCOSITY__INCLUDED_
...
public: 
	...
	typedef Material::Uniaxial::ShearViscosity::Energy<0> energy_type;
	typedef Material::Uniaxial::ShearViscosity::Jet<0> jet_type;
...
public: 
	...
	typedef Material::Uniaxial::ShearViscosity::Energy<1> tangent_type;
...
public: 
	...
	typedef Material::Uniaxial::ShearViscosity::Energy<2> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Material::Uniaxial::ShearViscosity::Energy<3> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Material::Uniaxial::ShearViscosity::Jet<1> tangent_type;
	typedef double domain_type;
...
public: 
	...
	typedef Material::Uniaxial::ShearViscosity::Jet<2> tangent_type;
	typedef double domain_type;
	typedef pair<double,double> range_type;
...
#endif // !defined(MATERIAL_UNIAXIAL_SHEARVISCOSITY__INCLUDED_)
