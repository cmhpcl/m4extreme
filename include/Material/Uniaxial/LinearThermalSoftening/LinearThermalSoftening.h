// LinearThermalSoftening.h: interface for the LinearThermalSoftening class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
//////////////////////////////////////////////////////////////////////

#if !defined(MATERIAL_UNIAXIAL_LINERATHERMALSOFTENING__INCLUDED_)
#define MATERIAL_UNIAXIAL_LINEARTHERMALSOFTENING__INCLUDED_
...
public: 
	...
	typedef Material::Uniaxial::LinearThermalSoftening::Energy<0> energy_type;
	typedef Material::Uniaxial::LinearThermalSoftening::Jet<0> jet_type;
...
public: 
	...
	typedef Material::Uniaxial::LinearThermalSoftening::Energy<1> tangent_type;
...
public: 
	...
	typedef Material::Uniaxial::LinearThermalSoftening::Energy<2> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Material::Uniaxial::LinearThermalSoftening::Energy<3> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Material::Uniaxial::LinearThermalSoftening::Jet<1> tangent_type;
	typedef double domain_type;
...
public: 
	...
	typedef Material::Uniaxial::LinearThermalSoftening::Jet<2> tangent_type;
	typedef double domain_type;
	typedef pair<double,double> range_type;
...
#endif // !defined(MATERIAL_UNIAXIAL_LINEARTHERMALSOFTENING__INCLUDED_)
