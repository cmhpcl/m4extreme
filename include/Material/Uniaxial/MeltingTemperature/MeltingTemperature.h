// MeltingTemperature.h: interface for the MeltingTemperature class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
//////////////////////////////////////////////////////////////////////

#if !defined(MATERIAL_UNIAXIAL_MeltingTemperature__INCLUDED_)
#define MATERIAL_UNIAXIAL_MeltingTemperature__INCLUDED_
...
public: 
	...
	typedef Material::Uniaxial::MeltingTemperature::Energy<0> energy_type;
	typedef Material::Uniaxial::MeltingTemperature::Jet<0> jet_type;
...
public: 
	...
	typedef Material::Uniaxial::MeltingTemperature::Energy<1> tangent_type;
...
public: 
	...
	typedef Material::Uniaxial::MeltingTemperature::Energy<2> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Material::Uniaxial::MeltingTemperature::Energy<3> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Material::Uniaxial::MeltingTemperature::Jet<1> tangent_type;
	typedef double domain_type;
...
public: 
	...
	typedef Material::Uniaxial::MeltingTemperature::Jet<2> tangent_type;
	typedef double domain_type;
	typedef pair<double,double> range_type;
...
#endif // !defined(MATERIAL_UNIAXIAL_MeltingTemperature__INCLUDED_)
