...
#if !defined(MATERIAL_TRANSPORT_ISOTROPIC_POTENTIAL_EXPONENTIAL__INCLUDED_)
#define MATERIAL_TRANSPORT_ISOTROPIC_POTENTIAL_EXPONENTIAL__INCLUDED_
...
public: 
	...
	typedef Material::Transport::Isotropic::Potential::Exponential::Data data_type;
	typedef Material::Transport::Isotropic::Potential::Exponential::Energy<0> energy_type;
...
public: 
	...
	typedef Material::Transport::Isotropic::Potential::Exponential::Energy<1> tangent_type;
	typedef double domain_type;
...
public: 
	...
	typedef Material::Transport::Isotropic::Potential::Exponential::Energy<2> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
#endif // !defined(MATERIAL_TRANSPORT_ISOTROPIC_POTENTIAL_EXPONENTIAL__INCLUDED_)
