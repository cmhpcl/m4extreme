...
#if !defined(MATERIAL_LAW_GAS_EOS_EXPONENTIAL__INCLUDED_)
#define MATERIAL_LAW_GAS_EOS_EXPONENTIAL__INCLUDED_
...
public: 
	...
	typedef Material::Gas::EoS::Exponential::Data data_type;
	typedef Material::Gas::EoS::Exponential::Energy<0> energy_type;
	typedef Material::Gas::EoS::Exponential::Jet<0> jet_type;
...
public: 
	...
	typedef Material::Gas::EoS::Exponential::Energy<1> tangent_type;
	typedef double domain_type;
...
public: 
	...
	typedef Material::Gas::EoS::Exponential::Energy<2> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Material::Gas::EoS::Exponential::Energy<3> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
#endif // !defined(MATERIAL_LAW_GAS_EOS_EXPONENTIAL__INCLUDED_)
