// NoTension.h: interface for the NoTension class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
//////////////////////////////////////////////////////////////////////

#if !defined(MATERIAL_GAS_EOS_NOTENSION__INCLUDED_)
#define MATERIAL_GAS_EOS_NOTENSION__INCLUDED_
...
public: 
	...
	typedef Material::Gas::EoS::NoTension::Energy<0> energy_type;
	typedef Material::Gas::EoS::NoTension::Jet<0> jet_type;
...
public: 
	...
	typedef Material::Gas::EoS::NoTension::Energy<1> tangent_type;
	typedef double domain_type;
...
public: 
	...
	typedef Material::Gas::EoS::NoTension::Energy<2> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Material::Gas::EoS::NoTension::Energy<3> tangent_type;
	typedef double domain_type;
	typedef double range_type;

	virtual ~Energy();
	Material::Gas::EoS::Energy<2> *Clone() const;
	Energy(Material::Gas::EoS::Energy<2> *);
	Energy(const Energy<2> &);
	range_type operator () (const domain_type &) const;

private:

	Material::Gas::EoS::Energy<2> *DDE;
...
public: 
	...
	typedef Material::Gas::EoS::NoTension::Jet<1> tangent_type;
	typedef double domain_type;
...
public: 
	...
	typedef Material::Gas::EoS::NoTension::Jet<2> tangent_type;
	typedef double domain_type;
	typedef pair<double,double> range_type;
...
#endif // !defined(MATERIAL_GAS_EOS_NOTENSION__INCLUDED_)
