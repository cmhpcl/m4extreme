...
#if !defined(MATERIAL_GAS_EOS_PRESSUREINTERPOLATION_INCLUDED_)
#define MATERIAL_GAS_EOS_PRESSUREINTERPOLATION_INCLUDED_
...
public:
        ...
        typedef Material::Gas::EoS::PressureInterpolation::Energy<0> energy_type;
...
public:
        ...
        typedef Material::Gas::EoS::PressureInterpolation::Energy<1> tangent_type;
...
public:
        ...
        typedef Material::Gas::EoS::PressureInterpolation::Energy<2> tangent_type;
        typedef double domain_type;
        typedef double range_type;
...
public:
        ...
        typedef Material::Gas::EoS::PressureInterpolation::Energy<3> tangent_type;
        typedef double domain_type;
        typedef double range_type;
...
public:
        ...
        typedef Material::Gas::EoS::PressureInterpolation::Jet<1> tangent_type;
        typedef double domain_type;
...
public:
  ...
  typedef Material::Gas::EoS::PressureInterpolation::Jet<2> tangent_type;
        typedef double domain_type;
        typedef pair<double,double> range_type;
...
#endif // !defined(MATERIAL_GAS_EOS_PRESSUREINTERPOLATION_INCLUDED_)
