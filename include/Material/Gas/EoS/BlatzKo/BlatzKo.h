// BlatzKo.h: interface for the BlatzKo class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
//////////////////////////////////////////////////////////////////////

#if !defined(MATERIAL_LAW_GAS_EOS_BLATZKO__INCLUDED_)
#define MATERIAL_LAW_GAS_EOS_BLATZKO__INCLUDED_
...
private:
	...
	double Mu, Nu, Alpha;
	double C1, x1, C2, x2;
	double DC1, dx1, DC2, dx2;
	double DDC1, ddx1, DDC2, ddx2;
};
...
public: 
	...
	typedef Material::Gas::EoS::BlatzKo::Energy<0> energy_type;
	typedef Material::Gas::EoS::BlatzKo::Jet<0> jet_type;
...
public: 
	...
	typedef Material::Gas::EoS::BlatzKo::Energy<1> tangent_type;
	typedef double domain_type;
...
public: 
	...
	typedef Material::Gas::EoS::BlatzKo::Energy<2> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Material::Gas::EoS::BlatzKo::Energy<3> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Material::Gas::EoS::BlatzKo::Jet<1> tangent_type;
	typedef double domain_type;
...
public: 
	...
	typedef Material::Gas::EoS::BlatzKo::Jet<2> tangent_type;
	typedef double domain_type;
	typedef pair<double,double> range_type;
...
#endif // !defined(MATERIAL_LAW_GAS_EOS_BLATZKO__INCLUDED_)
