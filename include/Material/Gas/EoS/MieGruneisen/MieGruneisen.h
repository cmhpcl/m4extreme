// MieGruneisen.h: interface for the MieGruneisen class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
////////////////////////////////////////////////////////////////////////////

#if !defined(MATERIAL_GAS_EOS_MIEGRUNEISEN__INCLUDED_)
#define MATERIAL_GAS_EOS_MIEGRUNEISEN__INCLUDED_
...
public: 
	...
	typedef Material::Gas::EoS::MieGruneisen::Energy<0> energy_type;
	typedef Material::Gas::EoS::MieGruneisen::Jet<0> jet_type;
...
public: 
	...
	typedef Material::Gas::EoS::MieGruneisen::Energy<1> tangent_type;
	typedef double domain_type;
...
public: 
	...
	typedef Material::Gas::EoS::MieGruneisen::Energy<2> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Material::Gas::EoS::MieGruneisen::Energy<3> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Material::Gas::EoS::MieGruneisen::Jet<1> tangent_type;
	typedef double domain_type;
...
public: 
	...
	typedef Material::Gas::EoS::MieGruneisen::Jet<2> tangent_type;
	typedef double domain_type;
	typedef pair<double,double> range_type;
...
#endif // !defined(MATERIAL_GAS_EOS_MIEGRUNEISEN__INCLUDED_)
