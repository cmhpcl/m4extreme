...
#if !defined(MATERIAL_GAS_EOS_QUADRATIC__INCLUDED_)
#define MATERIAL_GAS_EOS_QUADRATIC__INCLUDED_
...
private:
	double T0;
	m4extreme::Utils::ScalarField *	BulkModulus;
	m4extreme::Utils::ScalarField *	ThermalExpansion;
};
...
public: 
	...
	typedef Material::Gas::EoS::Quadratic::Energy<0> energy_type;
	typedef Material::Gas::EoS::Quadratic::Jet<0> jet_type;
...
public: 
	...
	typedef Material::Gas::EoS::Quadratic::Energy<1> tangent_type;
	typedef double domain_type;
...
public: 
	...
	typedef Material::Gas::EoS::Quadratic::Energy<2> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Material::Gas::EoS::Quadratic::Energy<3> tangent_type;
	typedef double domain_type;
	typedef double range_type;
...
public: 
	...
	typedef Material::Gas::EoS::Quadratic::Jet<1> tangent_type;
	typedef double domain_type;
...
public: 
	...
	typedef Material::Gas::EoS::Quadratic::Jet<2> tangent_type;
	typedef double domain_type;
	typedef pair<double,double> range_type;
...
#endif // !defined(MATERIAL_GAS_EOS_QUADRATIC__INCLUDED_)
