...
#if !defined(ELEMENT_ISOPARAMETRIC_LUMPEDMASS_H__INCLUDED_)
#define ELEMENT_ISOPARAMETRIC_LUMPEDMASS_H__INCLUDED_
...
#endif // !defined(ELEMENT_ISOPARAMETRIC_LUMPEDMASS_H__INCLUDED_
