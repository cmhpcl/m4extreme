// PorousTMElement.h: interface for the PorousTMElement class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
//////////////////////////////////////////////////////////////////////

#if !defined(ELEMENT_MATERIALPOINT_POROUSTMELEMENT_H__INCLUDED_)
#define ELEMENT_MATERIALPOINT_POROUSTMELEMENT_H__INCLUDED_
...
namespace Element
{
  ...
  {
    namespace PorousTMCoupling //ThermoMechanical Coupling
    {
	...
	private:
	  ...
	  void _ComputePressure_BackwardEuler();
	  void _ComputePressure_CrankNicolson();
	  void _ComputeSmoothedPressure_CrankNicolson();
