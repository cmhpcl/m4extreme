// Cylindrical.h: interface for the Cylindrical class.
// Copyright (c) 2017-2018 Extreme Computation Technology and Solutions, LLC 
// All rights reserved
// see file License.txt for license details
//////////////////////////////////////////////////////////////////////

#if !defined(MANIFOLD_EUCLIDEAN_CYLINDRICAL_H__INCLUDED_)
#define MANIFOLD_EUCLIDEAN_CYLINDRICAL_H__INCLUDED_
...
public:
	...
	typedef Set::Euclidean::Cylindrical::Vector vector_type;
	typedef Set::Euclidean::Cylindrical::Covector covector_type;
...
public:
	...
	typedef Set::Euclidean::Cylindrical::Covector dual_type;
	...
	Vector(const Set::Euclidean::Cylindrical::Point &);
	Vector & operator = (const Set::VectorSpace::Vector &);
	Vector & operator = (const Vector &);
	Vector & operator = (const Set::Euclidean::Cylindrical::Point &);
	Set::Manifold::Point & operator = (const Set::Manifold::Point &);
	bool operator != (const Set::Manifold::Point &) const;
	bool operator == (const Set::Manifold::Point &) const;
	void Randomize();
...
public:
	...
	typedef Set::Euclidean::Cylindrical::CovectorZero dual_type;
...
public:
	...
	typedef Set::Euclidean::Cylindrical::Vector dual_type;
	...
	Covector(const Set::Euclidean::Cylindrical::Vector &);
...
public:
	...
	typedef Set::Euclidean::Cylindrical::VectorZero dual_type;
	...
	CovectorZero(const Set::Euclidean::Cylindrical::VectorZero &);
...
public: 
	...
	typedef Set::Euclidean::Cylindrical::Embedding<1> tangent_type;
...
public: 
	...
	typedef Set::Euclidean::Cylindrical::Embedding<2> tangent_type;
	typedef Set::Euclidean::Cylindrical::Point domain_type;
...
public: 
	...
	typedef Set::Euclidean::Cylindrical::Submersion<1> tangent_type;
...
private:
	...
	Set::Euclidean::Cylindrical::Point x; 
};
...
public: 
	...
	typedef Set::Euclidean::Cylindrical::Submersion<2> tangent_type;
	typedef Set::Euclidean::Orthonormal::Point domain_type;
	typedef Set::VectorSpace::Hom range_type;
...
Set::Euclidean::Cylindrical::Point
operator + (const Set::Euclidean::Cylindrical::Point &,
			const Set::Euclidean::Cylindrical::Vector &);
Set::Euclidean::Cylindrical::Point
operator - (const Set::Euclidean::Cylindrical::Point &,
			const Set::Euclidean::Cylindrical::Vector &);
Set::Euclidean::Cylindrical::Vector
operator - (const Set::Euclidean::Cylindrical::Point &,
...
operator - (const Set::Euclidean::Cylindrical::Point &,
			const Set::VectorSpace::Vector &);
void Random(Set::Euclidean::Cylindrical::Point &);

#endif // !defined(MANIFOLD_EUCLIDEAN_CYLINDRICAL_H__INCLUDED_)
