...
#define KEYDATA_PATH_SIZE	255

#define KEYDATA_KEY_SIZE        256
#define KEYDATA_VAL_SIZE        255
...
CCXX_EXPORT(void) endKeydata(void);

typedef struct _keyval
{
	struct _keyval *next;
	char val[KEYDATA_VAL_SIZE + 1];
}	keyval_t;
 ...
 *  </pre></code>
 *
 * @author Henner Zeller <foobar@to.com>
 * @license LGPL
 */
