...
public:
   ...
   enum {Dimension = _Dimension, MaximumLevel = _MaximumLevel,
         NumberOfOrthants =
            numerical::Exponentiation<std::size_t, 2, _Dimension>::Result
        };
...
private:
   ...
   */
   std::tr1::array<Coordinate, Dimension> _coordinates;
...
public:
   ...
   SpatialIndex(const Level level,
                const std::tr1::array<Coordinate, Dimension>& coordinates) :
      _code(),
...
public:
   ...
   //! Get the coordinates.
   const std::tr1::array<Coordinate, Dimension>&
...
private:
   ...
   updateCode() {
      ...
      std::tr1::array<Coordinate, Dimension> c(_coordinates);
