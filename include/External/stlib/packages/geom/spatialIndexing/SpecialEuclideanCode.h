...
public:
   ...
   static const std::size_t BitsPerAxis = 3 + 2 * _SubdivisionLevels;
...
protected:
   ...
   typedef std::tr1::array<std::size_t, 3> AdjacentList;
...
protected:
   ...
   std::tr1::array<std::size_t, D> _bitsPerTranslation;
   // The centroids of the spherical triangles at each level of subdivision.
   std::tr1::array<std::vector<Point>, _SubdivisionLevels> _centroids;
...
#include "SpecialEuclideanCode.ipp"
