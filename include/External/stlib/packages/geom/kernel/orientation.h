...
template<typename T>
T
computeOrientationDeterminant(const std::tr1::array<T, 2>& a,
...
template<typename T>
T
computeInCircleDeterminant(const std::tr1::array<T, 2>& a,
                           const std::tr1::array<T, 2>& b,
                           const std::tr1::array<T, 2>& c,
                           const std::tr1::array<T, 2>& d);
...
inline
bool
isInCircle(const std::tr1::array<T, 2>& a,
           const std::tr1::array<T, 2>& b,
           const std::tr1::array<T, 2>& c,
           const std::tr1::array<T, 2>& d) {
