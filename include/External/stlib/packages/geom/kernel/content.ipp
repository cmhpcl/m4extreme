...
inline
T
computeDistance(const std::tr1::array<T, 1>& x, const std::tr1::array<T, 1>& y) {
   return y[0] - x[0];
}
...
inline
void
computeGradientOfDistance(const std::tr1::array<T, 1>& /*x*/,
                          const std::tr1::array<T, 1>& /*y*/,
                          std::tr1::array<T, 1>* gradient) {
   (*gradient)[0] = -1;
}
...
inline
T
computeVolume(const std::tr1::array<T, 3>& a, const std::tr1::array<T, 3>& b,
              const std::tr1::array<T, 3>& c, const std::tr1::array<T, 3>& d) {
   return
      (1. / 6) *
...
inline
T
computeVolume(const std::tr1::array<std::tr1::array<T, 3>, 4>& p) {
...
computeVolume(const std::tr1::array<T, N>& a, const std::tr1::array<T, N>& b,
   ...
   std::tr1::array<std::tr1::array<T, N>, 4> p = {{a, b, c, d}};
