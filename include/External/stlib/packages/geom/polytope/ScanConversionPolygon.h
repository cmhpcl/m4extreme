...
public:
   ...
   typedef std::tr1::array<Number, 2> Point;
...
public:
   ...
   */
   ...
   scanConvert(IndexOutputIterator coords,
               const std::tr1::array<std::size_t, 2>& extents) const {
      std::tr1::array<Index, 2> multiIndex = {{0, 0}};
   ...
   */
   ...
   const Index zCoordinate) const {
      std::tr1::array<Index, 3> multiIndex = {{0, 0, 0}};
...
private:
   ...
   */
   ...
   std::tr1::array<Index, N> multiIndex) const;
