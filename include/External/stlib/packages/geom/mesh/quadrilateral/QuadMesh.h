...
*/
template < std::size_t _N, typename T = double >
class QuadMesh {
   //
   // Enumerations.
   //
...
public:
   ...
   typedef T Number;
   //! A vertex.
   typedef std::tr1::array<T, _N> Vertex;
   //! A face of vertices.
   typedef std::tr1::array<Vertex, 4> Face;

   //! An indexed face.  (A face of indices.)
   typedef std::tr1::array<std::size_t, 4> IndexedFace;
