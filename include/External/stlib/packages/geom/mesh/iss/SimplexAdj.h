...
private:
   ...
   typedef std::tr1::array < std::size_t, M + 1 > IndexContainer;
...
public:
   ...
   SimplexAdj(const std::vector < std::tr1::array < std::size_t, M + 1 > > & simplices,
   ...
   void
   build(const std::vector < std::tr1::array < std::size_t, M + 1 > > & simplices,
         const VertexSimplexInc<M>& vertexSimplexInc);

   //! Construct from the number of vertices and the array of indexed simplices.
   SimplexAdj(const std::size_t numVertices,
              const std::vector < std::tr1::array < std::size_t, M + 1 > > & simplices) {
   ...
   const std::tr1::array < std::size_t, M + 1 > &
