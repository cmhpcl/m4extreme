...
public:
   ...
   typedef T Number;
   //! The point type.
   typedef std::tr1::array<Number, M> Point;
   //! The array of points.
   typedef array::MultiArray<Point, N> Array;
   //! A bounding box.
   typedef BBox<Number, N> BBox;
...
public:
   ...
   */
   StructuredGrid(const array::MultiArray<Point, N>& grid) :
      _grid(grid) {}
