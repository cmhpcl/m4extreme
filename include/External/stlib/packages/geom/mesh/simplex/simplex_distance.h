...
inline
T
computeUnsignedDistance(const std::tr1::array < std::tr1::array<T, 1>, 1 + 1 > & s,
                        const std::tr1::array<T, 1>& x) {
...
inline
T
computeUnsignedDistance(const std::tr1::array < std::tr1::array<T, 2>, 2 + 1 > & s,
                        const std::tr1::array<T, 2>& x) {
   return std::max(0., computeDistance(s, x));
}
...
inline
T
computeUnsignedDistance(const std::tr1::array < std::tr1::array<T, 3>, 3 + 1 > & s,
                        const std::tr1::array<T, 3>& x) {
   return std::max(0., computeDistance(s, x));
}
