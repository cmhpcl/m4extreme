...
inline
void
set(const std::tr1::array < std::tr1::array<T, 1>, 1 + 1 > & s,
    std::tr1::array<T, 1>* determinantGradient) {
...
inline
void
set(const std::tr1::array < std::tr1::array<T, 2>, 2 + 1 > & s,
    std::tr1::array<T, 2>* determinantGradient) {
   // 2 / sqrt(3)
...
inline
void
set(const std::tr1::array < std::tr1::array<T, 3>, 3 + 1 > & s,
    std::tr1::array<T, 3>* determinantGradient) {
