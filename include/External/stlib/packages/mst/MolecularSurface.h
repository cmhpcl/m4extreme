...
#include "triangulateAtomBot.h"

#include "../ads/array/ArrayWithNullHoles.h"
...
public:
   ...
   */
   MolecularSurface(const Number edgeLengthSlope = 0.0,
                    ...
                    ext::make_array(ext::make_array<Number>(0, 0, 0),
                                    ext::make_array<Number>(0, 0, 0),
                                    ext::make_array<Number>(0, 0, 0))) :
      _molecule(),
