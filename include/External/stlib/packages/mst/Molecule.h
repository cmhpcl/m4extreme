...
#include "../geom/orq/SortFirstDynamic.h"
...
private:
   ...
   typedef geom::SortFirstDynamic < 3, IdentifierAndAtomConstIterator, Point,
           Number, MultiKeyAccessor > ORQ;
   //! A bounding box.
