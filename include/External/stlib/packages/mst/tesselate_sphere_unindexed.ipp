...
void
makeOctahedron
(std::vector<std::tr1::array<std::tr1::array<T, 3>, 3> >& mesh) {
   typedef T Number;
...
inline
void
subdivide(std::vector<std::tr1::array<std::tr1::array<T, 3>, 3> >& mesh) {
   typedef T Number;
   typedef std::tr1::array<Number, 3> Point;
...
(const std::vector<std::tr1::array<std::tr1::array<T, 3>, 3> >& mesh) {
   typedef T Number;
