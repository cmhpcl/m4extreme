...
inline
bool
hasKnown(const array::SimpleMultiArrayConstRef<_T, _D>& grid) {
...
inline
bool
hasUnknown(const array::SimpleMultiArrayConstRef<_T, _D>& grid) {
...
(const array::SimpleMultiArrayConstRef<_T, _D>& grid,
 typename array::SimpleMultiArrayConstRef<_T, _D>::IndexList i) {
   typedef typename array::SimpleMultiArrayConstRef<_T, _D>::Index Index;
...
inline
std::size_t
countKnown(const array::SimpleMultiArrayConstRef<_T, _D>& grid) {
...
inline
std::size_t
countUnknown(const array::SimpleMultiArrayConstRef<_T, _D>& grid) {
...
inline
void
printLevelSetInfo(const array::SimpleMultiArrayConstRef<_T, _D>& grid,
                  std::ostream& out) {
