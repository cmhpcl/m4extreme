...
inline
void
labelComponent(const Grid<_T, _D, _N, _R>& f, Grid<_I, _D, _N, _R>* components,
               const typename Grid<_T, _D, _N, _R>::IndexList& gridIndex,
               const typename Grid<_T, _D, _N, _R>::IndexList& patchIndex,
               const _I identifier) {
...
inline
_I
labelComponents(const Grid<_T, _D, _N, _R>& f, Grid<_I, _D, _N, _R>* components) {
   typedef Grid<_T, _D, _N, _R> Grid;
   typedef typename Grid::IndexList IndexList;
   typedef typename Grid::VertexPatch FunctionPatch;
   typedef typename levelSet::Grid<_I, _D, _N, _R>::VertexPatch ComponentPatch;
