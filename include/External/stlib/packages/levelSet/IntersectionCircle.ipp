...
inline
_T
distance(const geom::Circle3<_T>& circle, const std::tr1::array<_T, 3>& x,
...
makeBoundaryIntersection(const geom::Ball<_T, 3>& a, const geom::Ball<_T, 3>& b,
   ...
   const _T c2 = squaredDistance(a.center, b.center);
