...
inline
void
contentAndBoundary(std::tr1::array<_T, 3> values,
                   std::tr1::array<std::tr1::array<_T, 2>, 3> locations,
                   const std::tr1::array<_T, 2>& lowerCorner,
                   const _T simplexContent, _T* content, _T* boundary,
                   _OutputIterator vertices) {
   typedef std::tr1::array<_T, 2> Point;
   ...
   *boundary = euclideanDistance(a, b);
...
inline
_T
content(std::tr1::array<_T, 3> values,
        std::tr1::array<std::tr1::array<_T, 2>, 3> locations,
        const _T simplexContent) {
   const std::tr1::array<_T, 2> lowerCorner = {{0, 0}};
   _T c, b;
...
inline
_T
boundary(std::tr1::array<_T, 3> values,
        std::tr1::array<std::tr1::array<_T, 2>, 3> locations,
        const _T simplexContent) {
   const std::tr1::array<_T, 2> lowerCorner = {{0, 0}};
   _T c, b;
...
inline
void
contentAndBoundary(std::tr1::array<_T, 4> values,
                   std::tr1::array<std::tr1::array<_T, 3>, 4> locations,
                   const std::tr1::array<_T, 3>& lowerCorner,
                   const _T simplexContent, _T* content, _T* boundary,
                   _OutputIterator vertices) {
...
inline
_T
content(std::tr1::array<_T, 4> values,
        std::tr1::array<std::tr1::array<_T, 3>, 4> locations,
        const _T simplexContent) {
   const std::tr1::array<_T, 3> lowerCorner = {{0, 0, 0}};
   _T c, b;
   ads::TrivialOutputIterator vertices;
...
inline
_T
boundary(std::tr1::array<_T, 4> values,
        std::tr1::array<std::tr1::array<_T, 3>, 4> locations,
        const _T simplexContent) {
   const std::tr1::array<_T, 3> lowerCorner = {{0, 0, 0}};
   _T c, b;
...
inline
void
voxelContentAndBoundary(array::EquilateralArray<_T, 1, 2> voxel,
                        const std::tr1::array<_T, 1>& lowerCorner,
   ...
   *boundary = 0.5;
   *vertices++ = lowerCorner + ext::make_array<_T>(t);
}
...
inline
_T
voxelContent(array::EquilateralArray<_T, 1, 2> voxel, const _T spacing) {
   _T c, b;
   ads::TrivialOutputIterator vertices;
   voxelContentAndBoundary(voxel, ext::filled_array<std::tr1::array<_T, 1> >(0),
...
inline
_T
voxelBoundary(array::EquilateralArray<_T, 1, 2> voxel, const _T spacing) {
   _T c, b;
   ads::TrivialOutputIterator vertices;
   voxelContentAndBoundary(voxel, ext::filled_array<std::tr1::array<_T, 1> >(0),
                           spacing, &c, &b, vertices);
...
inline
void
voxelContentAndBoundary(const array::EquilateralArray<_T, 2, 2>& voxel,
                        const std::tr1::array<_T, 2>& lowerCorner,
                        const _T spacing, _T* content, _T* boundary,
                        _OutputIterator vertices) {
   typedef std::tr1::array<_T, 2> Point;
   
   const std::tr1::array<Point, 4> VertexData = {{
         {{0, 0}},
         {{spacing, 0}},
         {{0, spacing}},
         {{spacing, spacing}}
      }};
   const array::EquilateralArray<Point, 2, 2> Vertices(VertexData);
   const _T simplexContent = 0.5 * spacing * spacing;

   *content = 0;
   *boundary = 0;
   _T c, b;
   std::tr1::array<_T, 3> values;
   std::tr1::array<Point, 3> locations;
...
inline
_T
voxelContent(const array::EquilateralArray<_T, 2, 2>& voxel, const _T spacing) {
   _T c, b;
   ads::TrivialOutputIterator vertices;
   voxelContentAndBoundary(voxel, ext::filled_array<std::tr1::array<_T, 2> >(0),
                           spacing, &c, &b, vertices);
   return c;
}
...
inline
_T
voxelBoundary(const array::EquilateralArray<_T, 2, 2>& voxel,
              const _T spacing) {
   _T c, b;
   ads::TrivialOutputIterator vertices;
   voxelContentAndBoundary(voxel, ext::filled_array<std::tr1::array<_T, 2> >(0),
...
inline
void
voxelContentAndBoundary(const array::EquilateralArray<_T, 3, 2>& voxel,
                        const std::tr1::array<_T, 3>& lowerCorner,
                        const _T spacing, _T* content, _T* boundary,
                        _OutputIterator vertices) {
   typedef std::tr1::array<_T, 3> Point;
   
   const std::tr1::array<Point, 8> VertexData = {{
         {{0, 0, 0}},
         {{spacing, 0, 0}},
         {{0, spacing, 0}},
         {{spacing, spacing, 0}},
   ...
   const array::EquilateralArray<Point, 3, 2> Vertices(VertexData);
   ...
   const std::tr1::array<std::tr1::array<std::size_t, 4>, 6> n = {{
         {{0, 1, 3, 7}},
         {{0, 1, 5, 7}},
         {{0, 2, 3, 7}},
         {{0, 2, 6, 7}},
   ...
   *boundary = 0;
   _T c, b;
   std::tr1::array<_T, 4> values;
   std::tr1::array<Point, 4> locations;
...
inline
_T
voxelContent(const array::EquilateralArray<_T, 3, 2>& voxel, const _T spacing) {
   _T c, b;
   ads::TrivialOutputIterator vertices;
   voxelContentAndBoundary(voxel, ext::filled_array<std::tr1::array<_T, 3> >(0),
                           spacing, &c, &b, vertices);
   return c;
}
...
inline
_T
voxelBoundary(const array::EquilateralArray<_T, 3, 2>& voxel,
              const _T spacing) {
   _T c, b;
   ads::TrivialOutputIterator vertices;
   voxelContentAndBoundary(voxel, ext::filled_array<std::tr1::array<_T, 3> >(0),
...
inline
void
getVoxel(const array::EquilateralArray<_T, 1, _N>& patch,
         const typename array::EquilateralArray<_T, 1, _N>::IndexList& index,
         array::EquilateralArray<_T, 1, 2>* voxel) {
#ifdef DEBUG_stlib
   assert(index[0] + 1 < patch.extents()[0]);
#endif
   typename array::EquilateralArray<_T, 1, _N>::Index i = index[0];
   (*voxel)[0] = patch(i);
   (*voxel)[1] = patch(i + 1);
}
...
inline
void
getVoxel(const array::EquilateralArray<_T, 2, _N>& patch,
         const typename array::EquilateralArray<_T, 2, _N>::IndexList& index,
         array::EquilateralArray<_T, 2, 2>* voxel) {
#ifdef DEBUG_stlib
   assert(index[0] + 1 < patch.extents()[0] &&
          index[1] + 1 < patch.extents()[1]);
#endif
   typename array::EquilateralArray<_T, 2, _N>::Index
      i = index[0], j = index[1];
   (*voxel)[0] = patch(i, j);
   (*voxel)[1] = patch(i + 1, j);
   (*voxel)[2] = patch(i, j + 1);
...
inline
void
getVoxel(const array::EquilateralArray<_T, 3, _N>& patch,
         const typename array::EquilateralArray<_T, 3, _N>::IndexList& index,
         array::EquilateralArray<_T, 3, 2>* voxel) {
#ifdef DEBUG_stlib
   assert(index[0] + 1 < patch.extents()[0] &&
          index[1] + 1 < patch.extents()[1] &&
          index[2] + 1 < patch.extents()[2]);
#endif
   typename array::EquilateralArray<_T, 3, _N>::Index
...
inline
void
contentAndBoundary(const array::EquilateralArray<_T, _D, _N>& patch,
                   const std::tr1::array<_T, _D>& lowerCorner,
                   const _T spacing, _T* content, _T* boundary,
                   _OutputIterator vertices) {
   typedef array::EquilateralArray<_T, _D, 2> Voxel;
   ...
   *boundary = 0;
   _T c, b;
   Voxel voxel;
   const std::tr1::array<_T, _D> delta =
      ext::filled_array<std::tr1::array<_T, _D> >(spacing);
   // Note the the voxel extents are one less than the vertex extents.
   const IndexList extents = patch.extents() - 1;
   ...
   for (Iterator i = Iterator::begin(extents); i != end; ++i) {
      ...
      if (allNonPositive(voxel.begin(), voxel.end())) {
         *content += voxelContent;
         ...
         voxelContentAndBoundary(voxel, lowerCorner + *i * delta, spacing,
                                 &c, &b, vertices);
         *content += c;
         *boundary += b;
      }
...
inline
_T
content(const array::EquilateralArray<_T, _D, _N>& patch,
        const _T spacing) {
   _T c, b;
   ads::TrivialOutputIterator vertices;
   contentAndBoundary(patch, ext::filled_array<std::tr1::array<_T, _D> >(0),
                      spacing, &c, &b, vertices);
   return c;
}
...
inline
_T
boundary(const array::EquilateralArray<_T, _D, _N>& patch,
        const _T spacing) {
   _T c, b;
   ads::TrivialOutputIterator vertices;
   contentAndBoundary(patch, ext::filled_array<std::tr1::array<_T, _D> >(0),
...
template<typename _T, std::size_t _D, std::size_t _N, typename _I,
         typename _OutputIterator>
inline
void
contentAndBoundary(const array::EquilateralArray<_T, _D, _N>& functionPatch,
                   const array::EquilateralArray<_I, _D, _N>& componentsPatch,
                   const std::tr1::array<_T, _D>& lowerCorner,
                   const _T spacing, std::vector<_T>* content,
                   std::vector<_T>* boundary, _OutputIterator vertices) {
   typedef array::EquilateralArray<_T, _D, 2> FunctionVoxel;
   typedef array::EquilateralArray<_I, _D, 2> ComponentsVoxel;
   ...
   const std::tr1::array<_T, _D> delta =
      ext::filled_array<std::tr1::array<_T, _D> >(spacing);
   // Note the the voxel extents are one less than the vertex extents.
   const IndexList extents = functionPatch.extents() - 1;
   // Loop over the voxels.
   const Iterator end = Iterator::end(extents);
   for (Iterator i = Iterator::begin(extents); i != end; ++i) {
      // Extract the voxel of function values.
      ...
      if (allNonPositive(functionVoxel.begin(), functionVoxel.end())) {
         const _I component = min(componentsVoxel);
         (*content)[component] += voxelContent;
      }
      else if (mixedSigns(functionVoxel.begin(), functionVoxel.end())) {
         voxelContentAndBoundary(functionVoxel, lowerCorner + *i * delta,
                                 spacing, &c, &b, vertices);
         const _I component = min(componentsVoxel);
         (*content)[component] += c;
...
contentAndBoundary(const Grid<_T, _D, _N>& grid, _T* content, _T* boundary,
                   _OutputIterator vertices) {
   typedef typename Grid<_T, _D, _N>::VoxelPatch VoxelPatch;
   typedef array::SimpleMultiIndexRangeIterator<_D> Iterator;
...
contentAndBoundary(const Grid<_T, _D, _N>& grid,
                   ...
                   _OutputIterator vertices) {
   typedef typename Grid<_T, _D, _N>::VoxelPatch FunctionPatch;
   typedef typename Grid<unsigned, _D, _N, _T>::VoxelPatch ComponentsPatch;
   typedef array::SimpleMultiIndexRangeIterator<_D> Iterator;

   Grid<unsigned, _D, _N, _T> components(grid.domain(), grid.extents());
