...
inline
bool
areFunctionsEqual(const array::SimpleMultiArrayConstRef<_T, _N>& f,
                  const array::SimpleMultiArrayConstRef<_T, _N>& g) {
...
inline
bool
areFunctionsEqual(const Grid<_T, _D, _N>& f, const Grid<_T, _D, _N>& g) {
   typedef typename Grid<_T, _D, _N>::VertexPatch VertexPatch;
...
inline
void
complement(array::SimpleMultiArrayRef<_T, _N>* f) {
...
template<typename _BinaryFunctor, typename _T, std::size_t _D, std::size_t _N>
inline
void
mapBinary(_BinaryFunctor functor, const Grid<_T, _D, _N>& f,
          const Grid<_T, _D, _N>& g, Grid<_T, _D, _N>* result) {
   typedef typename Grid<_T, _D, _N>::VertexPatch VertexPatch;
...
inline
void
unite(array::SimpleMultiArrayRef<_T, _N>* f,
      const array::SimpleMultiArrayConstRef<_T, _N>& g) {
   assert(f->extents() == g.extents());
...
inline
void
unite(const Grid<_T, _D, _N>& f, const Grid<_T, _D, _N>& g,
      Grid<_T, _D, _N>* result) {
   Unite<_T> functor;
...
inline
void
intersect(array::SimpleMultiArrayRef<_T, _N>* f,
          const array::SimpleMultiArrayConstRef<_T, _N>& g) {
   assert(f->extents() == g.extents());
   _intersect(f, g);
}
...
inline
void
intersect(const Grid<_T, _D, _N>& f, const Grid<_T, _D, _N>& g,
          Grid<_T, _D, _N>* result) {
...
inline
void
difference(array::SimpleMultiArrayRef<_T, _N>* f,
           const array::SimpleMultiArrayConstRef<_T, _N>& g) {
   assert(f->extents() == g.extents());
   _difference(f, g);
}
...
inline
void
difference(const Grid<_T, _D, _N>& f, const Grid<_T, _D, _N>& g,
           Grid<_T, _D, _N>* result) {
