...
inline
void
computeFaceNormal(const std::vector<std::tr1::array<T, 2> >& pos,
                  const std::vector<std::tr1::array<int, 2> >& conn,
                  const std::size_t n, std::tr1::array<T, 2>* normal,
                  Loki::Int2Type<2> /* dummy */) {
   std::tr1::array<T, 2> tangent(pos[conn[n][1]]);
...
inline
void
computeFaceNormal(const std::vector<std::tr1::array<T, 3> >& pos,
                  const std::vector<std::tr1::array<int, 3> >& conn,
                  const std::size_t n, std::tr1::array<T, 3>* normal,
                  Loki::Int2Type<3> /* dummy */) {
   const std::tr1::array<int, 3>& face = conn[n];
...
inline
void
computeFaceNormal(const std::vector<std::tr1::array<T, N> >& pos,
                  const std::vector<std::tr1::array<int, N> >& conn,
                  const std::size_t n, std::tr1::array<T, N>* normal) {
