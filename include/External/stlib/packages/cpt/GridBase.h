...
#include "../array/MultiIndexRangeIterator.h"
...
protected:
   ...
   //! An extent in N-D.
   typedef typename array::MultiIndexTypes<N>::SizeList SizeList;
   ...
   typedef array::MultiIndexRange<N> Range;
   //! An index range iterator.
   typedef array::MultiIndexRangeIterator<N> MultiIndexRangeIterator;
   //! A lattice.
...
private:
   ...
   //! Array of distances.
   array::MultiArray<Number, N> _distance;
   //! Array of gradient of distance.
   array::MultiArray<Point, N> _gradientOfDistance;
   //! Array of closest points.
   array::MultiArray<Point, N> _closestPoint;
   //! Array of closest faces.
   array::MultiArray<std::size_t, N> _closestFace;
...
public:
   ...
   const array::MultiArray<Number, N>&
   getDistance() const {
      return _distance;
   }

   //! Return a const reference to the gradient of the distance grid.
   const array::MultiArray<Point, N>&
   ...
   const array::MultiArray<std::size_t, N>&
