...
public:
   ...
   typedef std::tr1::tuple<std::size_t, Point> Force;
...
protected:
   ...
   typedef std::tr1::array < Point, N + 1 > Simplex;
   //! A proxy ball.
...
protected:
   ...
   std::vector < std::tr1::array < std::size_t, N + 1 > > _indexSimplices;
...
protected:
   ...
   /*!
     ...
     The penetration vector is represented with a std::tr1::array<Number,N>.
