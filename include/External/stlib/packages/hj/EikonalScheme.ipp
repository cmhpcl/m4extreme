...
print_inverse_speed_array(std::ostream& out,
                          const array::MultiArrayConstRef<T, 2>& inverseSpeed) {
   typedef typename array::MultiArrayConstRef<T, 2>::IndexList IndexList;
   typedef typename array::MultiArrayConstRef<T, 2>::Index Index;
...
void
print_inverse_speed_array(std::ostream& out,
                          const array::MultiArrayConstRef<T, 3>& inverseSpeed) {
   typedef typename array::MultiArrayConstRef<T, 3>::IndexList IndexList;
   typedef typename array::MultiArrayConstRef<T, 3>::Index Index;
