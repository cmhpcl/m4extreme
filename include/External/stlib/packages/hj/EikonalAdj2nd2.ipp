...
diff_adj(const IndexList& i, const IndexList& d) const {
   ...
   if (_status(i2, j2) == KNOWN &&
      ...
      return diff_a2(_solution(i1, j1), _solution(i2, j2), _inverseSpeed(i));
   }
   ...
   if (_status(bi1, bj1) == KNOWN) {
      if (_status(ai2, aj2) == KNOWN &&
         ...
         if (_status(bi2, bj2) == KNOWN &&
            ...
            return diff_a2_a2(_solution(ai1, aj1),
                              _solution(ai2, aj2),
                              _solution(bi1, bj1),
                              _solution(bi2, bj2),
                              _inverseSpeed(i));
            ...
            return diff_a2_a1(_solution(ai1, aj1),
                              _solution(ai2, aj2),
                              _solution(bi1, bj1),
                              _inverseSpeed(i));
         }
         ...
         if (_status(bi2, bj2) == KNOWN &&
               _solution(bi1, bj1) > _solution(bi2, bj2)) {
            return diff_a2_a1(_solution(bi1, bj1),
                              _solution(bi2, bj2),
                              _solution(ai1, aj1),
                              _inverseSpeed(i));
         }
