...
inline
void
initialize(array::MultiArrayRef<T, N>& array) {
...
template<std::size_t N, typename T>
void
computeUnsignedDistance(array::MultiArrayRef<T, N>& array,
...
template<std::size_t N, typename T>
void
computeSignedDistance(array::MultiArrayRef<T, N>& array, T dx,
                      T maximumDistance = 0);
...
template<std::size_t N, typename T>
void
floodFillUnsignedDistance(array::MultiArrayRef<T, N>& array,
...
template<std::size_t N, typename T>
void
floodFillSignedDistance(array::MultiArrayRef<T, N>& array,
                        T maximumDistance, T fillValue = 0);
...
template<std::size_t N, typename T>
void
convertLevelSetToSignedDistance(array::MultiArrayRef<T, N>& array, T dx,
                                T isoValue = 0,
                                T maximumDistance = 0,
                                T fillValue = 0);
...
(array::MultiArrayRef<F, 3>& field,
 const geom::RegularGrid<3, T>& grid,
 const array::MultiArrayConstRef<T, 3>& distance,
 T maximumDistance,
 F defaultValue);
...
/*!
  Wrapper for
  initialize(array::MultiArrayRef<T,2>& array)
*/
template<typename T>
inline
void
initialize(const std::size_t extentX, const std::size_t extentY, T* data) {
   const std::tr1::array<std::size_t, 2> extents = {{extentX, extentY}};
   initialize(array::MultiArrayRef<T, 2>(extents, data));
}
...
/*!
  Wrapper for
  initialize(array::MultiArrayRef<T,3>& array)
*/
template<typename T>
inline
void
initialize(const std::size_t extentX, const std::size_t extentY,
   ...
   const std::tr1::array<std::size_t, 3> extents =
      {{extentX, extentY, extentZ}};
   initialize(array::MultiArrayRef<T, 3>(extents, data));
}
...
/*!
  Wrapper for
  computeUnsignedDistance(array::MultiArrayRef<T,2>& array,T dx,T maximumDistance)
*/
template<typename T>
inline
void
computeUnsignedDistance(const std::size_t extentX, const std::size_t extentY,
   ...
   const std::tr1::array<std::size_t, 2> extents = {{extentX, extentY}};
   computeUnsignedDistance(array::MultiArrayRef<T, 2>(extents, data),
                           dx, maximumDistance);
}
...
/*!
  Wrapper for
  computeUnsignedDistance(array::MultiArrayRef<T,3>& array,T dx,T maximumDistance)
*/
template<typename T>
inline
void
computeUnsignedDistance(const std::size_t extentX, const std::size_t extentY,
   ...
   const std::tr1::array<std::size_t, 3> extents =
      {{extentX, extentY, extentZ}};
   computeUnsignedDistance(array::MultiArrayRef<T, 3>(extents, data),
                           dx, maximumDistance);
}
...
/*!
  Wrapper for
  computeSignedDistance(array::MultiArrayRef<T,2>& array,T dx,T maximumDistance)
*/
template<typename T>
inline
void
computeSignedDistance(const std::size_t extentX, const std::size_t extentY,
                      T* data, const T dx, const T maximumDistance = 0) {
   const std::tr1::array<std::size_t, 2> extents = {{extentX, extentY}};
   computeSignedDistance(array::MultiArrayRef<T, 2>(extents, data),
                         dx, maximumDistance);
}
...
/*!
  Wrapper for
  computeSignedDistance(array::MultiArrayRef<T,3>& array,T dx,T maximumDistance)
*/
template<typename T>
inline
void
computeSignedDistance(const std::size_t extentX, const std::size_t extentY,
   ...
   const std::tr1::array<std::size_t, 3> extents =
      {{extentX, extentY, extentZ}};
   computeSignedDistance(array::MultiArrayRef<T, 3>(extents, data),
                         dx, maximumDistance);
}
...
/*!
  Wrapper for
  floodFillUnsignedDistance(array::MultiArrayRef<T,2>& array,T maximumDistance,T fillValue)
*/
template<typename T>
inline
void
floodFillUnsignedDistance(const std::size_t extentX, const std::size_t extentY,
   ...
   const std::tr1::array<std::size_t, 2> extents = {{extentX, extentY}};
   floodFillUnsignedDistance(array::MultiArrayRef<T, 2>(extents, data),
...
/*!
  Wrapper for
  floodFillUnsignedDistance(array::MultiArrayRef<T,3>& array,T maximumDistance,T fillValue)
*/
template<typename T>
inline
void
floodFillUnsignedDistance(const std::size_t extentX, const std::size_t extentY,
   ...
   const std::tr1::array<std::size_t, 3> extents =
      {{extentX, extentY, extentZ}};
   floodFillUnsignedDistance(array::MultiArrayRef<T, 3>(extents, data),
                             maximumDistance, fillValue);
}
...
/*!
  Wrapper for
  floodFillSignedDistance(array::MultiArrayRef<T,2>& array,T maximumDistance,T fillValue)
*/
template<typename T>
inline
void
floodFillSignedDistance(const std::size_t extentX, const std::size_t extentY,
                        ...
                        const T maximumDistance, const T fillValue = 0) {
   const std::tr1::array<std::size_t, 2> extents = {{extentX, extentY}};
   floodFillSignedDistance(array::MultiArrayRef<T, 2>(extents, data),
                           maximumDistance, fillValue);
}
...
/*!
  Wrapper for
  floodFillSignedDistance(array::MultiArrayRef<T,3>& array,T maximumDistance,T fillValue)
*/
template<typename T>
inline
void
floodFillSignedDistance(const std::size_t extentX, const std::size_t extentY,
   ...
   const std::tr1::array<std::size_t, 3> extents =
      {{extentX, extentY, extentZ}};
   floodFillSignedDistance(array::MultiArrayRef<T, 3>(extents, data),
                           maximumDistance, fillValue);
}
...
/*!
  Wrapper for
  convertLevelSetToSignedDistance(array::MultiArrayRef<T,2>& array,T dx,T isoValue,T maximumDistance,T fillValue)
*/
template<typename T>
inline
void
convertLevelSetToSignedDistance(const std::size_t extentX,
                                ...
                                const T fillValue = 0) {
   const std::tr1::array<std::size_t, 2> extents = {{extentX, extentY}};
   convertLevelSetToSignedDistance(array::MultiArrayRef<T, 2>(extents, data),
...
/*!
  Wrapper for
  convertLevelSetToSignedDistance(array::MultiArrayRef<T,3>& array,T dx,T isoValue,T maximumDistance,T fillValue)
*/
template<typename T>
inline
void
convertLevelSetToSignedDistance(const std::size_t extentX,
   ...
   const std::tr1::array<std::size_t, 3> extents =
      {{extentX, extentY, extentZ}};
   convertLevelSetToSignedDistance(array::MultiArrayRef<T, 3>(extents, data),
                                   dx, isoValue, maximumDistance, fillValue);
}
