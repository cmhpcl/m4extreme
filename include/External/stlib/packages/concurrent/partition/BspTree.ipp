...
(const array::MultiArrayConstRef<_T, 1>& costs,
 array::MultiArrayRef<std::size_t, 1>* identifiers,
 const _T totalCost, geom::SemiOpenInterval<1, std::ptrdiff_t> indexRange,
 std::size_t identifiersBegin, std::size_t identifiersEnd) {
   typedef typename array::MultiArrayConstRef<_T, 1>::IndexList IndexList;
...
inline
void
tightenIndexRange(const array::MultiArrayConstRef<std::size_t, 2>& identifiers,
                  geom::SemiOpenInterval<2, std::ptrdiff_t>* indexRange,
                  const std::size_t value) {
   typedef array::MultiArrayConstRef<std::size_t, 2>::IndexList
   IndexList;
   IndexList index;
   bool hasValue;
...
void
partitionRegularGridWithBspTree
(const array::MultiArrayConstRef<_T, 2>& costs,
 array::MultiArrayRef<std::size_t, 2>* identifiers,
 ...
 const std::size_t predictionThreshhold) {
   typedef typename array::MultiArrayConstRef<std::size_t, 2>::SizeList SizeList;
   typedef typename array::MultiArrayConstRef<std::size_t, 2>::IndexList
   IndexList;
...
inline
void
tightenIndexRange(const array::MultiArrayConstRef<std::size_t, 3>& identifiers,
geom::SemiOpenInterval<3, std::ptrdiff_t>* indexRange,
const std::size_t value) {
   typedef array::MultiArrayConstRef<std::size_t, 3>::IndexList IndexList;
   IndexList index;
   bool hasValue;
...
void
partitionRegularGridWithBspTree
(const array::MultiArrayConstRef<_T, 3>& costs,
array::MultiArrayRef<std::size_t, 3>* identifiers,
const _T totalCost, geom::SemiOpenInterval<3, std::ptrdiff_t> indexRange,
std::size_t identifiersBegin, std::size_t identifiersEnd) {
   typedef typename array::MultiArrayConstRef<std::size_t, 3>::SizeList SizeList;
   typedef typename array::MultiArrayConstRef<std::size_t, 3>::IndexList
   IndexList;
