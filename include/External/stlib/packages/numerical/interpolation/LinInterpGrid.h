...
public:
   ...
   //! The field array.
   typedef array::MultiArray<Field, N> FieldArray;
...
public:
   ...
   */
   LinInterpGrid(const array::MultiArray<Field, N>& fields,
                 const BBox& domain) :
      _fields(fields),
   ...
   */
   void
   build(const array::MultiArray<Field, N>& fields, const BBox& domain) {
      _fields = fields;
