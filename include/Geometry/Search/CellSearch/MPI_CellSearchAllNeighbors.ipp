...
#if !defined(__geom_MPI_CellSearchAllNeighbors_ipp__)
#error This file is an implementation detail of the class MPI_CellSearchAllNeighbors.
#endif
...
inline
void
MPI_CellSearchAllNeighbors<_Dim>::
...
template<unsigned int _Dim>
inline
typename MPI_CellSearchAllNeighbors<_Dim>::IndexList
MPI_CellSearchAllNeighbors<_Dim>::
...
template<unsigned int _Dim>
inline
typename MPI_CellSearchAllNeighbors<_Dim>::Index
MPI_CellSearchAllNeighbors<_Dim>::
