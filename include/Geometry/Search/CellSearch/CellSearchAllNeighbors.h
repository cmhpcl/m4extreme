...
/*!
  \file CellSearchAllNeighbors.h
  \brief A class for computing all neighbors of the input records.
*/

#if !defined(__geom_CellSearchAllNeighbors_h__)
#define __geom_CellSearchAllNeighbors_h__
...
*/
  ...
  class CellSearchAllNeighbors : public Geometry::Search<Set::Manifold::Point*> {
   //
   // Types.
   //

public:
    typedef typename Geometry::Search<Set::Manifold::Point*>  BASE;
...
private:
   ...
   CellSearchAllNeighbors();

   // Copy constructor not implemented
   CellSearchAllNeighbors(const CellSearchAllNeighbors&);

   // Assignment operator not implemented
   CellSearchAllNeighbors&
   operator=(const CellSearchAllNeighbors&);
...
public:
   ...
   //! Construct from the search radius.
    CellSearchAllNeighbors(const map<Record, point_type> & points_, const double searchRadius_) :
...
#define __geom_CellSearchAllNeighbors_ipp__
#include "CellSearchAllNeighbors.ipp"
#undef __geom_CellSearchAllNeighbors_ipp__
